        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body table-responsive p-0">
                    <form action="{{route('need.store')}}" method="post" class="p-2" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <div class=" col-6">
                                <label>عنوان نقشه</label>
                                <input type="text" class="form-control" placeholder="نقشه ضروری علوم" name="title">
                            </div>
                            <div class=" col-6">
                                <label>کتاب</label>
